...
- The preconditioner is assembled once during initialisation and then frozen; subsequent curvature adjustments are entirely handled by the lazy L-BFGS rank-2 updates inside the two-loop recursion.
